...
import { ISpeakerBasicSearch, ISpeakerPutRequest, ISpeakerBasicResponse, ISpeakerByIdResponse, ISpeakerByIdSearch, ISpeakerDeleteRequest, } from "@/admin/model/speaker/speakerModel";
