...
function ScheduleBody() {
      return (
            ...
            >
                  ...
                  <section className="flex flex-col justify-start items-start gap-16 w-full h-full bg-red/0">
                        <div className="flex flex-col gap-4 w-full h-full px-6 py-4 border border-l-2 border-l-red border-default ">
                              <section className="flex justify-between items-start w-full h-full">
                                    ...
                                    <span className="flex flex-col items-center text-sm">
                                          <h5 className="text-3xl font-semibold text-red">26</h5>
                                          <h6 className="font-semibold text-red">JANUARY</h6>
                                    </span>
                              </section>
                              ...
                              <section className="flex gap-3">
                                    ...
                                    <img
                                          ...
                                          alt=""
                                    />
                                    <div className="w-12 h-12 flex items-center justify-center rounded-md font-bold text-white bg-red">
                                          <p>+10</p>
                                    </div>
                              </section>
                              <button type="button" className="text-sm font-bold text-red self-end">
                                    Mark my place
                              </button>
                        </div>
                        <div className="flex flex-col gap-4 w-full h-full px-6 py-4 border border-l-2 border-l-red border-default ">
                                                ...
                                                <span className="min-w-[80%] max-w-[10rem] overflow-scroll no-scrollbar">
                                                      <div className="flex gap-1.5 w-full text-xs">
                                                            {[
                                                                  ...
                                                                  <p
                                                                        key={index}
                                                                        className="px-1.5 py-0.5 select-none bg-red/20 text-red rounded-sm min-w-fit"
                                                                  >
                                                                        {status}
                                                                  </p>
                                                            ))}
