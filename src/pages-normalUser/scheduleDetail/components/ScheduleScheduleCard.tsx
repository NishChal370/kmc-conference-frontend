            ...
            <aside className="hidden lg:flex flex-col gap-6 min-w-[22rem] w-[22rem] max-w-[22rem]">
                  ...
                  >
                        <span title="Date & Time">
                              <AppIcon name="clock" className=" text-gray-400" size={ICON.size + 10} />
                              <p className="text-base">Saturday, January 30, 2024 at 16:00 to 19:00</p>
                        </span>

                        <span title="Location">
                              <AppIcon name="location" className=" text-gray-400" size={ICON.size + 4} />
                              <article>
                        ...
                        <span title="Parking">
                              <AppIcon name="parking" className=" text-gray-400" size={ICON.size + 4} />
                              <article>
                        ...
                        <span title="Accommodation">
                              <AppIcon name="accommodation" className=" text-gray-400" size={ICON.size + 4} />
                              <article>
                  ...
                  <img className="w-full h-60" src="https://i.stack.imgur.com/HILmr.png" alt="" />
            </aside>
      );
}
