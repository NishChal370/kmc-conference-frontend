...
function Button({
      ...
      const defaultClassName = {
            ...
            outlined: "group flex items-center gap-1.5 bg-transparent text-primary border border-primary py-2 px-6 rounded-md uppercase tracking-wider w-full active:shadow-button",
